...
async function createInitialClothing() {
    ...
    try {
        ...
        const clothingToCreate = [
            ...
            {clothing: "stocking cap", description: 'A Grey one size fits all stocking cap', size: 'one size fits all', color: 'grey', price: 20.00, inventory: 10, img: 'pictures/stockingCapss/greyStockingCap.jpg'},
            {clothing: "stocking cap", description: 'A Red one size fits all stocking cap', size: 'one size fits all', color: 'red', price: 20.00, inventory: 10, img: 'pictures/stockingCapsredStockingCap.jpg'},
